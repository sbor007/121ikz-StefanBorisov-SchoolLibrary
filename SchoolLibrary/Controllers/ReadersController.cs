...
namespace SchoolLibrary.Controllers
{
    public class ReadersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FullName,Email,ClassName")] Reader reader)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FullName,Email,ClassName")] Reader reader)
        {
            if (id != reader.Id)
            {
                return NotFound();
